...
with open('networks/networks_NOdropout/results/det_train_error_NOdropout.pkl') as f:  # Python 3: open(..., 'wb')
...
with open('networks/networks_NOdropout/results/stoch_train_error_NOdropout.pkl') as f:  # Python 3: open(..., 'wb')
